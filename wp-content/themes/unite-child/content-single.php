	...
	<div class="entry-content">
		...
		<tbody>
			<tr>
				...
				<td><?php echo get_the_term_list( get_the_ID( ), 'country-tag', '', ', ', '' ) ?></td>
			</tr>

			<tr>
				<th scope="row">Genres</th>
				<td><?php echo get_the_term_list( get_the_ID( ), 'genre-tag', '', ', ', '' ) ?></td>
			</tr>

			<tr>
				<th scope="row">Ticket Price</th>
				<td><b>Rs.</b><?php echo  get_post_meta(get_the_ID(), 'ticket-price', true); ?>/-</td>
			</tr>

			<tr>
				<th scope="row">Film Release Date</th>
				<td><?php echo  get_post_meta(get_the_ID(), 'release-date', true); ?></td>
			</tr>
		</tbody>
		</table>
		<?php
